    ...
    return(
        <div className="Maincontainer-PI">
            <div className="Left-PI">
                <img src={`http://localhost/VhongWebsite/backend/images/${promo.model}`} alt={promo.name} />
            </div>
            ...
            <div className="Right-PI">
                ...
                <div className="Diplay-PI">
                    <div className="Left-display">
                        <img src={`http://localhost/VhongWebsite/backend/images/${promo.display}`} alt={promo.name} />
                    </div>
